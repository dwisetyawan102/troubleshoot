...
<br />
* Monitor no display (lampu LED indikaor mati / tidak menyala hitam / tidak menampilkan tulisan atau icon-icon tertentu sama sekali)
    * periksa kabel power monitor -done
    * lepas kebel power monitor dari LCD atau stopcontact, colokan lagi -done
* Monitor no display (lampu LED menyala monitor menyala tapi hitam / hanya menampilkan tulisan atau icon-icon tertentu saja)
